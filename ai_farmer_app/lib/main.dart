...
import 'package:ai_farmer_app/splash_screen.dart';
import 'package:ai_farmer_app/tp_screen.dart';
import 'package:ai_farmer_app/weather_forecast.dart';
import 'package:ai_farmer_app/welcome_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(primaryColor: AppColors.greenn
