...
class AppColors {
  static const Color greenn = Color(0xFF0C8F5D);
  static const Color black = Color(0xFF2b2b2b);
  static const Color discountColor = Color(0xFF123D86);
  static const Color lightGrey1 = Color(0xFFEDF0F7);
  ...
  static const Color red = Color(0xFFfe3044);
  static const Color secondary = Color(0xff4880E2);
  static const Color white = Color(0xFFf5f7fe);
  static const Color filterWhite = Color(0xFFF5F7FE);
  ...
  static const lightGrey = Color(0xFFc9ccd1);
  ...
  static const Color couponBottomModelButtonGradient1 = Color(0xff528AEE);
  static const Color couponBottomModelButtonGradient2 = Color(0xff1157CA);
  static const Color couponBottomModelButtonBorder = Color(0xff155ACC);
  static const Color couponBottomModelButtonFill = Color(0xffE4EDFF);
  static const Color switchFill = Color(0xffE9DEF5);
  static const Color switchOffThumb = Color(0xffC9B2EA);
  static const Color switchOnThumb = Color(0xff4E2A84);
  static const Color legacyDeck = Color(0xffEC9D80);
  static const Color sweetToothDeck = Color(0xff61DCC9);
  static const Color gamingZoneDeck = Color(0xff0002C7);
  static const Color barhoppingDeck = Color(0xffDE9423);
  static const Color mexicanDeck = Color(0xffD7250B);
  static const Color pizzaDeck = Color(0xffAB8549);
  static const Color romanticDeck = Color(0xff632328);
  static const Color bookingpagecontainers = Color(0xffEDF0F7);
}
//white: #f5f7fe
//black: #2b2b2b
//light grey: #c9ccd1
